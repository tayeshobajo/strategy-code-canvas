          ...
          offers: [
            {
              ...
              description: "The diagnosis and the route to Point B.",
              price: "10000",
              priceCurrency: "USD",
              category: "Roadmap",
              url: "https://new.trusttai.com/investment#map",
            },
            {
              "@type": "Offer",
              name: "Standard Roadmap",
              description: "The full map, every pillar named.",
              price: "17500",
              priceCurrency: "USD",
              category: "Roadmap",
              url: "https://new.trusttai.com/investment#map",
            },
            {
              ...
              description: "Deep modeling for layered operations.",
              price: "25000",
              priceCurrency: "USD",
              category: "Roadmap",
              url: "https://new.trusttai.com/investment#map",
            },
            {
              "@type": "Offer",
              name: "The Fast Walk",
              description: "Point B in twelve months. Heaviest team on the build.",
              price: "7500",
              priceCurrency: "USD",
              priceSpecification: {
              ...
              category: "Build engagement",
              url: "https://new.trusttai.com/investment",
            },
            {
              "@type": "Offer",
              name: "The Middle Walk",
              description: "Point B in eighteen months.",
              price: "4500",
              priceCurrency: "USD",
              priceSpecification: {
                "@type": "UnitPriceSpecification",
            ...
            },
            {
              ...
              description: "Point B in twenty-four months. The walk most founders fund from operations.",
              price: "2500",
              priceCurrency: "USD",
              priceSpecification: {
                "@type": "UnitPriceSpecification",
