...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/apple-touch-icon-152x152.png?v=2", sizes: "152x152" },
      { rel: "manifest", href: "/manifest.webmanifest?v=2" },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Inter:wght@400;500;600;700;800;900&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://trusttai.com/#organization",
              name: "Trust Tai",
              alternateName: "Trust Tai Consultancy + AI Agency",
              url: "https://trusttai.com",
              logo: "https://trusttai.com/favicon.ico",
              description:
              ...
              contactPoint: {
                ...
                email: "hello@trusttai.com",
                url: "https://trusttai.com/build-my-roadmap",
              },
            },
            {
              "@type": "WebSite",
              "@id": "https://trusttai.com/#website",
              name: "Trust Tai",
              url: "https://trusttai.com",
              publisher: { "@id": "https://trusttai.com/#organization" },
            },
          ],
        }),
      },
