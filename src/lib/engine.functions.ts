...
export const getProjectWorkspace = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context, data }): Promise<{ project: WorkspaceProject; dates: Array<{ id: string; label: string; due_on: string; kind: string }>; activity: Array<{ id: string; kind: string; title: string; body: string | null; severity: string; created_at: string }> }> => {
    ...
    const project: WorkspaceProject = {
      ...
      signal_room: (row.signal_room as Record<string, unknown>) ?? {},
      extraction: (row.extraction as Record<string, unknown>) ?? {},
      point_a: (row.point_a as Record<string, unknown>) ?? {},
      point_b: (row.point_b as Record<string, unknown>) ?? {},
      hidden_assets: (row.hidden_assets as Record<string, unknown>) ?? {},
      gap_map: (row.gap_map as Record<string, unknown>) ?? {},
      blueprint: (row.blueprint as Record<string, unknown>) ?? {},
      roadmap: (row.roadmap as Record<string, unknown>) ?? {},
      sequencing: (row.sequencing as Record<string, unknown>) ?? {},
      deadlines: (row.deadlines as Record<string, unknown>) ?? {},
      investment: (row.investment as Record<string, unknown>) ?? {},
      client_preview: (row.client_preview as Record<string, unknown>) ?? {},
